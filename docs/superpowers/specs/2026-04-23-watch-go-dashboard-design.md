...
[각 앱 repo]                     [이 repo]                    [GitHub Pages]
 docs/app/overview.md                                          watch-go-dashboard
 docs/app/updates.md  ──────▶  Actions (daily 03:00 KST)
                             │
...
```json
{
  ...
  "stats": { "total": 17, "succeeded": 16, "no_docs": 0, "failed": 1 },
  "apps": [
    {
      "id": 100,
      "name": "My Photo Watch Face: watch-go",
...
- **업데이트 섹션:** 최신 5개 버전만. 더 보려면 repo의 `docs/app/updates.md` 링크 안내.
